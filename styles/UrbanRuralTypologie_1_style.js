var size = 0;
var placement = 'point';
function categories_UrbanRuralTypologie_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case '101':
...
var style_UrbanRuralTypologie_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("urban_rura");
    var labelText = "";
    size = 0;
...
var style = categories_UrbanRuralTypologie_1(feature, value, size, resolution, labelText,
